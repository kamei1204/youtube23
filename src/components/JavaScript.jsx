...
const JavaScript = () => {
  return (
    <>
      <Canvas style={{width: `60%`, height: `100%`,  position: `relative`, left: `10vw`, bottom: `10vw`, cursor:`pointer`, overflow:`hidden` }} camera={{position: [20, 0, 100], fov: 45}} >
      ...
      <Description>「かわいらしい外見」「豊かな表情」「親しみやすい性格」「遊び心と活発さ」があり大好きです</Description>
    </>
  )
}
